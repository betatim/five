export default {
  faq: {
    question1: {
      answer:
        'Die hier erstellt E-ID wird, nach heutigem Kenntnisstand, per 2. Oktober 2020 fürs Signieren nach Schweizer Gesetz (ZertES) deaktiviert werden müssen. Die E-ID kann jedoch weiterhin fürs Signieren nach europäischen Gesetzt (eIDAS) eingesetzt werden.',
    ...
    question11: {
      answer:
        'Ja. Ihr Passwort ist an Ihre E-ID geknüpft und kommt immer zum Zug, wenn sie mit einem Anbieter signieren, der auf dem Swisscom Signing Service beruht.',
      question:
        'Ist mein Signaturpasswort auf allen Signaturservices dasselbe?',
    },
    question2: {
      answer:
        'Die E-ID wird nach höchsten Sicherheitsstandards, verschlüsselt in den Rechenzentren der Swisscom abgelegt. Die E-ID kann nur im Falle eines Rechtsfalls von den Sicherheitsleuten des Swisscom Signing Service im 4-Augen-Prinzip entschlüsselt und den Behörden zur Verfügung gestellt werden.',
    ...
    question3: {
      ...
      question: 'Für was kann ich die E-ID alles nutzen?',
    },
    question4: {
      answer:
    ...
    question7: {
      answer:
        'Die Video-Identifikation dauert ca. 5 Minuten. Je nach Auslastung des Video-Identifikations-Team kann die Wartezeit bis zum Start der Videoidentifikation bis zu 2 Minuten betragen.',
  ...
  intro: {
    content: {
      paragraph1:
        'Um mit QES signieren zu können, muss man seine Identität einmalig überprüfen lassen. Bis am 02. Oktober 2020 ist das per Video-Call möglich. Der Bund {0}, um die Notwendigkeit für persönlichen Kontakt zu reduzieren und der gestiegenen Nachfrage für elektronisches Signieren nachzukommen.',
      paragraph1_linkText:
  ...
  payment: {
    failure: {
      after_payment: {
        paragraph1:
          'Die Zahlung war erfolgreich, aber wir konnten keinen Identifikationsprozess erstellen. Klicken Sie auf Erneut senden, um es nochmals zu versuchen.',
    ...
    form: {
      country: 'Land',
      country_is_required: 'Land wird benötigt',
      email: 'E-Mail',
