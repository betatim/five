export default {
  faq: {
    ...
    question7: {
      answer:
        'Die Identifikation via Video wurde in der Schweiz durch eine befristete Ausnahmeregelung ermöglicht, die vom Bund im Rahmen von COVID-19 für sechs Monate in Kraft gesetzt wurde. Diese Ausnahmeregelung läuft am 01. Oktober aus. Sie müssen sich einmalig im persönlichen Kontakt identifizieren lassen, um nach dem 01. Oktober weiterhin auf Stufe "qualifiziert" nach Schweizer Recht elektronisch signieren zu können. \n<br><br>\nIhnen steht ein  <a href="https://www.skribble.com/de/qes-freischalten" target="_blank">Netz an Identifikationsstandorten</a> in allen vier Sprachregionen der Schweiz zur Verfügung, an denen Sie sich kostenlos identifizieren lassen können. Kommen Sie vorbei und bringen Sie einen gültigen Pass oder Identitätskarte sowie Ihr Mobiltelefon mit.\n<br><br>\n <strong>Hinweis:</strong> Die Gültigkeit von Signaturen, die Sie vor dem 01. Oktober mit einer Video-basierten Identifikation erstellt haben, bleibt erhalten.',
      question:
        'Muss ich meine Identität zum Signieren nach Schweizer Recht nach dem 1. Oktober 2020 erneut prüfen lassen?',
    },
    question8: {
      answer:
        'Der Preis gilt für die Identifikation, die zum elektronischen Signieren mit QES  befähigt. Nicht enthalten sind die elektronischen Signaturen, die später gemacht werden.',
      question: 'Was ist im Preis enthalten?',
    },
    question9: {
      answer:
        'Die geprüfte Identität wird nach höchsten Sicherheitsstandards und verschlüsselt in den Rechenzentren der Swisscom abgelegt. Sie kann nur im Rechtsfall vom Sicherheitspersonal des Swisscom Signing Service im Vier-Augen-Prinzip entschlüsselt und den Behörden zur Verfügung gestellt werden.',
      question: 'Wo werden meine Daten gespeichert?',
    },
    title: 'Noch Fragen? Das Wichtigste in Kürze.',
  },
  footer: {
  ...
  intro: {
    content: {
      paragraph1:
        '<strong>Wichtiger Hinweis für die Schweiz:</strong> Die Identifikation via Video wurde in der Schweiz durch eine befristete <a href="https://www.admin.ch/gov/de/start/dokumentation/medienmitteilungen.msg-id-78641.html" target="_blank">Ausnahmeregelung</a> ermöglicht, die vom Bund im Rahmen von COVID-19 für sechs Monate in Kraft gesetzt wurde. Diese Ausnahmeregelung läuft am 01. Oktober aus. Sie müssen sich einmalig im persönlichen Kontakt identifizieren lassen, um nach dem 01. Oktober weiterhin auf Stufe "qualifiziert" nach Schweizer Recht elektronisch signieren zu können. \n<br><br>\nDazu steht Ihnen ein <a href="https://www.skribble.com/de/qes-freischalten" target="_blank">Netz an Identifikationsstandorten</a> in allen vier Sprachregionen der Schweiz zur Verfügung, an denen Sie sich kostenlos identifizieren lassen können.',
      paragraph1_linkText:
  ...
  payment: {
    ...
    form: {
      ...
      terms_linkText: 'Datenschutzbestimmungen',
  ...
  steps: {
    ...
    step3: {
      ...
      title: 'Signatur-Passwort festlegen',
    },
    subtitle:
      'Die Identitätsprüfung erfolgt online und dauert nur wenige Minuten. Im Anschluss wird die QES innerhalb von 30 Minuten auf <a href="https://www.skribble.com" target="_blank">Skribble</a> freigeschaltet.',
