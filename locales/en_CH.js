export default {
  faq: {
    ...
    question3: {
      ...
      question: 'What can I use the e-ID for?',
    },
    question4: {
      answer:
    ...
    question5: {
      ...
      answer_linkText:
        'See the list of accepted countries and identity documents',
      answer_linkURL:
    ...
    question7: {
      answer:
        'The video identification takes about 5 minutes. Depending on the workload of the team, the waiting period may take up to 2 minutes before the video identification starts.',
      question: 'How long does the video identification take?',
    },
    question8: {
      answer: 'You can accomplish the identification in German and English.',
      question: 'In which language can I carry out the video identification?',
    },
    question9: {
      answer:
        'The price includes identification via video and the subsequently generated electronic identity (e-ID). The signatures that are made with this e-ID are not included.',
